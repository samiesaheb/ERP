...
const ICONS: Record<string, React.ReactElement> = {
  ...
  '/formulations':         <Icon path="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />,
  ...
  '/locations':            <Icon path="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" path2="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />,
  ...
  '/mrp':                  <Icon path="M4 19h16M4 15h10M4 11h7M4 7h13" path2="M17 5l3 3-3 3" />,
  ...
  '/login-attempts':       <Icon path="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />,
...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Login Attempts',   href: '/login-attempts' },
    ],
  },
];
